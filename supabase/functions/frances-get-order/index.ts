...
// session_id: es criptográficamente aleatorio y solo lo tiene quien acaba de
// pagar (llega en la URL de redirect de Stripe y en el email de confirmación).
...
Deno.serve(async (req: Request) => {
  ...
  const product = EBOOK_CATALOG[order.product_slug];
  if (!product) {
