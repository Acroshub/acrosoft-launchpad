...
import {
  ...
  ArrowLeft, LogOut, FileText, MessageSquare, Info,
} from "lucide-react";
                ...
                {clients.map((c, i) => (
                  <tr key={c.id} className="border-b hover:bg-secondary/30 transition-colors">
                    ...
                    <td className="px-4 py-3">
                      <div className="flex gap-2">
                        <Button size="sm" variant="ghost" onClick={() => setViewingClient(c.id)}><Eye size={14} className="mr-1" /> Ver</Button>
            ...
            {clients.map((c) => (
              <div key={c.id} className="border rounded-lg p-4 space-y-2">
                ...
                <div className="flex gap-2 pt-1">
                  <Button size="sm" variant="outline" onClick={() => setViewingClient(c.id)}><Eye size={14} className="mr-1" /> Ver</Button>
