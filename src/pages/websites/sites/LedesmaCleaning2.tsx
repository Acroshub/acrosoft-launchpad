...
import { Phone, MapPin, ChevronDown, ChevronLeft, ChevronRight, Shield, Clock, Leaf, Home, Building2, Star, CheckCheck, Sparkles, Wind, Check } from "lucide-react";
...
const FAQS = [
  ...
  { q: "How do I get a quote?", a: "Book directly through our calendar above, or call us at (706) 264-6654. We'll give you a straight price — no hidden fees, no surprises." },
  ...
  if (submitted) {
    return (
      <div className="min-h-[420px] flex flex-col items-center justify-center text-center">
        ...
        <h4 className="text-slate-900 font-black text-xl lcs-h">Booking Confirmed!</h4>
    ...
    return (
      <div className="min-h-[420px] flex flex-col">
        <div className="mb-5 p-3.5 bg-sky-50 border border-sky-200 rounded-xl flex items-center justify-between gap-3">
          <div>
            <div className="text-[9px] font-black tracking-[2px] uppercase text-slate-400 lcs-h mb-0.5">Your Appointment</div>
            <div className="text-slate-900 font-black text-sm lcs-h">{MONTH_NAMES[month]} {selectedDay} · {selectedSlot}</div>
          </div>
          <button onClick={() => setStep(1)} className="text-sky-500 text-xs font-bold hover:underline cursor-pointer lcs-h shrink-0">
            ← Change
          </button>
        </div>

        <p className="text-[9px] font-black tracking-[2px] uppercase text-slate-400 mb-3 lcs-h">Your Contact Info</p>
        ...
        <button
          ...
          className="mt-5 w-full bg-sky-500 text-white font-black py-3 rounded-xl text-sm transition-all duration-200 disabled:opacity-40 disabled:cursor-not-allowed hover:bg-sky-600 hover:scale-[1.02] lcs-h cursor-pointer">
          Confirm Booking →
        </button>
      </div>
    );
  ...
  return (
    <div className="min-h-[420px] flex flex-col">
      <div className="flex items-center justify-between mb-3">
        ...
        <span className="font-black text-slate-900 text-sm lcs-h tracking-wide">{MONTH_NAMES[month]} {year}</span>
      ...
      <div className="mt-3 pt-3 border-t border-slate-200">
        <p className="text-[9px] font-black tracking-[2px] uppercase text-slate-400 mb-2 lcs-h">
      ...
      <button
        ...
        className="mt-4 w-full bg-[#0A2540] text-white font-black py-3 rounded-xl text-sm transition-all duration-200 disabled:opacity-30 disabled:cursor-not-allowed enabled:hover:bg-[#0f3060] enabled:hover:scale-[1.02] lcs-h cursor-pointer">
        Continue →
      </button>
    </div>
  );
...
// ── PAGE ──────────────────────────────────────────────────────────────────────
export default function LedesmaCleaning2() {
    ...
    <div className="overflow-x-hidden bg-white" style={{ fontFamily: "'Inter', sans-serif" }}>
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-5 sm:px-8 pt-8 lg:pt-20 pb-0">
          <div className="grid lg:grid-cols-[1fr_420px] gap-10 xl:gap-16 items-start">
            ...
            <div className="pb-8 lg:pb-24">
              ...
              <h1 className="hidden lg:block text-[clamp(2.4rem,6vw,4.4rem)] font-black text-slate-900 leading-[1.0] tracking-[-0.025em] mb-6 lcs-h">
                A clean space.<br />
            ...
            <div id="booking" className="relative">
              <div className="bg-white rounded-2xl shadow-2xl border border-slate-200 overflow-hidden">
                <div className="bg-[#0A2540] px-6 pt-6 pb-5 border-b border-slate-200/20">
                  <span className="text-sky-400 text-[10px] font-black tracking-[3px] uppercase lcs-h">Free · No Commitment</span>
                  <h3 className="text-white font-black text-xl mt-1.5 lcs-h leading-tight">Book Your Free Cleaning</h3>
      ...
      <section id="services" className="py-24 px-5 sm:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mt-10">
            <a href="#booking" className="inline-flex flex-col items-center bg-sky-500 hover:bg-sky-600 text-white px-10 py-4 rounded-xl transition-all duration-200 cursor-pointer lcs-h shadow-sm hover:shadow-[0_4px_14px_rgba(14,165,233,0.4)] hover:scale-[1.02]">
      ...
      <section id="why-us" className="py-24 px-5 sm:px-8 bg-sky-300">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mt-10">
            <a href="#booking" className="inline-flex flex-col items-center bg-[#0A2540] hover:bg-[#0f3060] text-white px-10 py-4 rounded-xl transition-all duration-200 cursor-pointer lcs-h shadow-md hover:scale-[1.02]">
              <span className="font-bold text-base">Book Free Cleaning</span>
      ...
      <section id="areas" className="relative py-24 px-5 sm:px-8 bg-[#0A2540] overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto">
          ...
          <div className="text-center">
            <a href="#booking" className="inline-flex flex-col items-center bg-sky-500 hover:bg-sky-600 text-white px-10 py-4 rounded-xl transition-all duration-200 cursor-pointer lcs-h shadow-md hover:shadow-[0_4px_20px_rgba(14,165,233,0.45)] hover:scale-[1.02]">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid lg:grid-cols-[1fr_400px] gap-12 items-center">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-xl">
              ...
              <a href="#booking" className="w-full flex flex-col items-center bg-sky-500 hover:bg-sky-600 text-white py-4 rounded-xl transition-all duration-200 cursor-pointer lcs-h shadow-sm hover:shadow-[0_4px_18px_rgba(14,165,233,0.5)] hover:scale-[1.02]">
                <span className="font-bold text-base">Book Free Cleaning</span>
                <span className="text-white/65 text-sm flex items-center gap-1.5 mt-0.5">Free · No Commitment</span>
              </a>
