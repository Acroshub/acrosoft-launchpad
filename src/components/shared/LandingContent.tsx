...
const LandingContent = ({ calendarId, services }: Props) => {
  ...
  return (
    <div className="min-h-screen bg-background selection:bg-blue-500/20">
            ...
            <div id="agendar" className="relative scroll-mt-24">
              ...
              >
                <div className="flex items-center gap-3 px-6 py-5 border-b border-slate-100">
                  ...
                  <div>
                    <p className="text-sm font-bold text-slate-900 leading-none">Agenda tu cita</p>
                    <p className="text-[11px] text-slate-400 mt-0.5">Selecciona día y hora disponible</p>
                  </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {TESTIMONIALS.map((t, i) => (
              <div
                key={t.name}
                className={`lp-reveal lp-d${i + 1} bg-white rounded-2xl p-7 border border-slate-200 hover:border-blue-200 hover:shadow-xl hover:-translate-y-1 transition-all duration-300`}
              >
